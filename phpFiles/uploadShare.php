...
$valueSHARE = $myfile->pictures[0]->picture[0]->shareName;
...
try {
    ...
    $sql = "INSERT INTO posts (_id, username, base64, titel, hashtags, date, liked, userKey, userPic, shareName)
VALUES ($valueID, '$valueNAME', '$valueBASE', '$valueTITEL', '$valueHASHTAGS', '$valueDATUM', $valueLIKE, $valueUSERKEY, '$valueUSERPIC', '$valueSHARE' )";
    // use exec() because no results are returned
    $conn->exec($sql);
    echo "SharedSuccessfully";
    }
