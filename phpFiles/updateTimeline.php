...
$valueHighestPost = $myfile->post[0]->highID;
...
for($i=0; $i < count($FIDssplit); $i++){
    ...
    $getAllPostIDs= $conn->prepare("SELECT _id FROM posts WHERE userKey=$valueKey AND _id > $valueHighestPost ;");
